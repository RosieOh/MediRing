...
@Configuration
@ComponentScan(basePackages = {"com.mediring.service", "com.mediring.registory"})
@MapperScan(basePackages = {"com.mediring.persistance"})
public class RootConfig {
    ...
    public BasicDataSource dataSource() {   //데이터베이스 설정
        ...
        basicDataSource.setUrl("jdbc:mariadb://localhost:3306/mediring");
